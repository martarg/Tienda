...
abstract class JSON_WebServer_Controller extends CI_Controller 
{
    ...
    /**
     * Devuelve en formato JSON la respuesta e incluye la información de depuración si está activada
     */
    ...
    /**
     * Muestra la ayuda sobre los métodos que se han publicado para el controlador
     */
